      ...
      >
        ...
        <div class="flex items-center md:order-2">
          ...
          >
            ...
            <span
              class="px-2 py-[1px] flex-none text-xs border text-gray-400 rounded"
              >Ctrl K</span
            >
          </button>
          ...
          >
            ...
            <li>
              <a
                ...
                :class="[
                  currPath == '/tag/list' ? 'text-blue-700' : 'text-gray-900',
                ]"
  ...
  >
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <!-- Modal footer -->
        <div
          class="p-4 md:p-5 border-t text-xs flex items-center text-gray-400"
        >
          <!-- Esc 退出提示 -->
